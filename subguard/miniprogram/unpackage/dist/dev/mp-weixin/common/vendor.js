...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_DARK_MODE":"false","VUE_APP_NAME":"SubGuard","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 30 */
/*!******************************************************!*\
  !*** D:/机器学习/订阅管理系统/subguard/miniprogram/pages.json ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 43 */
/*!********************************************************!*\
  !*** D:/机器学习/订阅管理系统/subguard/miniprogram/utils/api.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

/* WEBPACK VAR INJECTION */(function(uni, wx) {var _defineProperty = __webpack_require__(/*! @babel/runtime/helpers/defineProperty */ 11);
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
...
function buildUrl(path) {
  ...
  return "".concat(BASE_URL).concat(path);
}
function normalizeError(res) {
  ...
  return "\u8BF7\u6C42\u5931\u8D25\uFF0C\u72B6\u6001\u7801 ".concat(res.statusCode);
}
  ...
  return new Promise(function (resolve, reject) {
    client().uploadFile({
      ...
      success: function success(res) {
        ...
        reject(new Error(data.error || data.message || "\u4E0A\u4F20\u5931\u8D25\uFF0C\u72B6\u6001\u7801 ".concat(res.statusCode)));
      },
      fail: function fail(error) {
...
function getSubscriptionById(id) {
  return request("/subscriptions/".concat(id));
}
...
function getUpcomingSubscriptions() {
  ...
  return request("/subscriptions/upcoming?days=".concat(days));
}
...
function getCancelGuide(paymentMethod) {
  return request("/cancel-guides?payment_method=".concat(encodeURIComponent(paymentMethod || '')));
}
module.exports = {
  BASE_URL: BASE_URL,
  request: request,
  ...
  getUpcomingSubscriptions: getUpcomingSubscriptions,
  importText: importText,
  importImage: importImage,
  importCSV: importCSV,
  getStatsSummary: getStatsSummary,
  getCancelGuide: getCancelGuide
};
