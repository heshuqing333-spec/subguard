...
/***/ 54:
/*!**************************************************************************************!*\
  !*** D:/机器学习/订阅管理系统/subguard/miniprogram/main.js?{"page":"pages%2Fdetail%2Fdetail"} ***!
  \**************************************************************************************/
...
/***/ 55:
/*!*******************************************************************!*\
  !*** D:/机器学习/订阅管理系统/subguard/miniprogram/pages/detail/detail.vue ***!
  \*******************************************************************/
/*! no static exports found */
...
/* harmony import */ var _detail_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./detail.vue?vue&type=style&index=0&lang=css& */ 60);
...
/***/ 56:
/*!**************************************************************************************************!*\
  !*** D:/机器学习/订阅管理系统/subguard/miniprogram/pages/detail/detail.vue?vue&type=template&id=3e159eb4& ***!
  \**************************************************************************************************/
...
/***/ 57:
/*!**************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--17-0!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/template.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-uni-app-loader/page-meta.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/机器学习/订阅管理系统/subguard/miniprogram/pages/detail/detail.vue?vue&type=template&id=3e159eb4& ***!
  \**************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns, recyclableRender, components */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 58:
/*!********************************************************************************************!*\
  !*** D:/机器学习/订阅管理系统/subguard/miniprogram/pages/detail/detail.vue?vue&type=script&lang=js& ***!
  \********************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 59:
/*!***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--13-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/机器学习/订阅管理系统/subguard/miniprogram/pages/detail/detail.vue?vue&type=script&lang=js& ***!
  \***************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _default = {
  data: function data() {
    return {
      ...
      cycleLabels: cycles.map(function (item) {
        return item.label;
      }),
      statusLabels: statuses.map(function (item) {
        return item.label;
      }),
      categoryIndex: 5,
      cycleIndex: 0,
  ...
  methods: {
    load: function load() {
      var _this = this;
      api.getSubscriptionById(this.id).then(function (data) {
        _this.form = _objectSpread(_objectSpread(_objectSpread({}, _this.form), data), {}, {
          price: String(data.price || '')
        });
        _this.categoryIndex = Math.max(0, _this.categories.indexOf(_this.form.category));
        _this.cycleIndex = Math.max(0, cycles.findIndex(function (item) {
          return item.value === _this.form.cycle;
        }));
        _this.paymentIndex = Math.max(0, _this.payments.indexOf(_this.form.payment_method));
        _this.statusIndex = Math.max(0, statuses.findIndex(function (item) {
          return item.value === _this.form.status;
        }));
      });
    },
    ...
    pickCycle: function pickCycle(e) {
      this.cycleIndex = Number(e.detail.value);
      this.form.cycle = cycles[this.cycleIndex].value;
    },
    pickDate: function pickDate(e) {
      this.form.next_due_date = e.detail.value;
    },
    pickPayment: function pickPayment(e) {
      this.paymentIndex = Number(e.detail.value);
      this.form.payment_method = this.payments[this.paymentIndex];
    },
    pickStatus: function pickStatus(e) {
      this.statusIndex = Number(e.detail.value);
      this.form.status = statuses[this.statusIndex].value;
    },
    ...
    submit: function submit() {
      ...
      var payload = _objectSpread(_objectSpread({}, this.form), {}, {
        ...
        usage_count: Number(this.form.usage_count),
        importance: Number(this.form.importance)
      });
      this.submitting = true;
      var req = this.isEdit ? api.updateSubscription(this.id, payload) : api.createSubscription(payload);
      req.then(function () {
        uni.showToast({
          title: _this2.isEdit ? '已更新' : '已添加'
        });
        setTimeout(function () {
...
/***/ 60:
/*!****************************************************************************************************!*\
  !*** D:/机器学习/订阅管理系统/subguard/miniprogram/pages/detail/detail.vue?vue&type=style&index=0&lang=css& ***!
  \****************************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 61:
/*!********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--6-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--6-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--6-oneOf-1-2!./node_modules/postcss-loader/src??ref--6-oneOf-1-3!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/机器学习/订阅管理系统/subguard/miniprogram/pages/detail/detail.vue?vue&type=style&index=0&lang=css& ***!
  \********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
